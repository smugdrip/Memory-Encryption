/** 
    @file DESMagic.c
    @author dbsturgi
    I put all the majic numbers needed by DES in this one file.  That
    way, you won't get complaints about these random-looking numbers
    showing up in your other soruce files.
